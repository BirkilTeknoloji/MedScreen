...
('Ayse', 'Demir', 'doctor', 'Dahiliye', 'DR123457', '05321234568', true, NULL),
('Fatma', 'Kara', 'nurse', NULL, 'NS123458', '05321234569', true, NULL),
('Ali', 'Celik', 'doctor', 'Ortopedi', 'DR123459', '05321234570', true, NULL),
('Zeynep', 'Sahin', 'receptionist', NULL, NULL, '05321234571', true, NULL),
('Hasan', 'Ozturk', 'admin', NULL, NULL, '05321234572', true, NULL);
...
UPDATE users SET nfc_card_id = 2 WHERE id = 2;
UPDATE users SET nfc_card_id = 3 WHERE id = 3;
UPDATE users SET nfc_card_id = 4 WHERE id = 5;
UPDATE users SET nfc_card_id = 5 WHERE id = 6;
