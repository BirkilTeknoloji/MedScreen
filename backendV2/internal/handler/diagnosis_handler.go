...
func (h *DiagnosisHandler) CreateDiagnosis(c *gin.Context) {
	...
	utils.SendSuccessResponse(c, http.StatusCreated, constants.SUCCESS_DIAGNOSIS_CREATED, "Diagnosis created successfully", diagnosis)
}
...
func (h *DiagnosisHandler) GetDiagnosis(c *gin.Context) {
	...
	if err != nil {
		utils.SendErrorResponse(c, http.StatusBadRequest, constants.ERROR_INVALID_DIAGNOSIS_ID, "Invalid diagnosis ID", err)
		return
	}

	diagnosis, err := h.service.GetDiagnosis(uint(id))
	if err != nil {
		utils.SendErrorResponse(c, http.StatusNotFound, constants.ERROR_DIAGNOSIS_NOT_FOUND, "Diagnosis not found", err)
		return
	}

	utils.SendSuccessResponse(c, http.StatusOK, constants.SUCCESS_DIAGNOSIS_RETRIEVED, "Diagnosis retrieved successfully", diagnosis)
}
...
func (h *DiagnosisHandler) GetDiagnoses(c *gin.Context) {
	...
	if patientID != nil || doctorID != nil || appointmentID != nil || startDate != nil || endDate != nil {
		...
		utils.SendSuccessResponseWithMeta(c, http.StatusOK, constants.SUCCESS_DIAGNOSES_RETRIEVED, "Diagnoses retrieved successfully", diagnoses, meta)
		return
	}
...
func (h *DiagnosisHandler) UpdateDiagnosis(c *gin.Context) {
	...
	utils.SendSuccessResponse(c, http.StatusOK, constants.SUCCESS_DIAGNOSIS_UPDATED, "Diagnosis updated successfully", diagnosis)
}
...
func (h *DiagnosisHandler) DeleteDiagnosis(c *gin.Context) {
	...
	utils.SendSuccessResponse(c, http.StatusOK, constants.SUCCESS_DIAGNOSIS_DELETED, "Diagnosis deleted successfully", nil)
}
